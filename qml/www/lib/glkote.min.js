...
var keycode=0;if(ev)keycode=ev.which;
//console.log("At start. keycode: " + keycode);
...
return;}
var win;if(windows_paging_count){win=windowdic[last_known_paging];if(win){if(!((keycode>=32&&keycode<=126)||keycode==13||keycode==229)){return;}
...
function evhan_input_char_keypress(ev){var keycode=0;if(ev)keycode=ev.which;
//console.log("keycode: " + keycode + " ? " + ev.which);
if(!keycode){return false};var res;if(keycode==13)
res='return';else
if(keycode==229)
res=$("input").val()[0];else
